  ...
  if (variant === 'nav') {
    return (
      <div className={`min-w-0 w-full ${className}`} aria-label="Progreso de creación del evento">
        <div className="flex items-center justify-between gap-1 text-[10px] font-medium leading-tight text-gray-600">
          <span className="truncate">Paso 1 de 2 — {step1Label}</span>
          <span className="hidden shrink-0 sm:inline">2: Compartir</span>
        </div>
